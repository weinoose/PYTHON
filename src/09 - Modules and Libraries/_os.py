...
result = os.mkdir("WEINOOSE") # Kodu yazdığınız dizinde bir klasör açar.
result = os.rename("weinoose.py","WEINOOSE.py") # 2 Parametre alır. İlk parametre orijinal dosyanın ismidir. Dosya ismi değiştirir.
result = os.listdir()
