...
__version__ = '1.1.2'
__author__ = 'Emir Yarkın Yaman'
__author_email__ = 'weinoose@gmail.com'
...
def create_next_candidates(prev_candidates, length):
    ...
    # Return all the candidates if the length of the next candidates is because their subsets are the same as items.
    if length < 3:
        return list(tmp_next_candidates)

    # Filter candidates that all of their subsets are in the previous candidates.
    next_candidates = [
